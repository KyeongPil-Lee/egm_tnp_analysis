...
baseDir_puTree = '/pnfs/iihe/cms/store/user/kplee/EGMTnPTree/2024-09-19/UL2018/merged_240926/'
baseOutDir = 'results/sGain/UL2018/tnpEleID/'
...
samplesDef = {
    'data'   : tnpSamples.UL2018_sGain['data_Run2018A'].clone(),
    'mcNom'  : tnpSamples.UL2018_sGain['DY_amcatnloext'].clone(),
    'mcAlt'  : tnpSamples.UL2018_sGain['DY_madgraph'].clone(),
    'tagSel' : tnpSamples.UL2018_sGain['DY_amcatnloext'].clone(),
}

## can add data sample easily
samplesDef['data'].add_sample( tnpSamples.UL2018_sGain['data_Run2018B'] )
samplesDef['data'].add_sample( tnpSamples.UL2018_sGain['data_Run2018C'] )
samplesDef['data'].add_sample( tnpSamples.UL2018_sGain['data_Run2018D'] )
...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree(baseDir_puTree+'DY_amcatnloext_ele.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree(baseDir_puTree+'DY_madgraph_ele.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree(baseDir_puTree+'DY_amcatnloext_ele.pu.puTree.root')
...
biningDef = [
   ...
   { 'var' : 'el_sc_eta' , 'type': 'float', 'bins': [-2.5, -1.566,-1.4442, 0.0, 1.4442, 1.566, 2.5] }, # reduce eta binning (EB/EE only)
   { 'var' : 'el_pt' , 'type': 'float', 'bins': [10,20,35,50,100,200,500] },
   { 'var' : 'el_seedGain' , 'type': 'int', 'bins': [1, 6, 12] },
]
