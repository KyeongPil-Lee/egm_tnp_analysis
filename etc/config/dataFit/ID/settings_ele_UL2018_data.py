...
baseOutDir = 'results/UL2018/ID/DataTrueTemplate'
...
theTnPSample = tnpSamples.dataFit_18_ID
list_ptBinEdge = list_ptBinEdge_1718

samplesDef = {
    'data'   : theTnPSample['data_Run2018A'].clone(),
...
samplesDef['data'].add_sample( theTnPSample['data_Run2018B'] )
samplesDef['data'].add_sample( theTnPSample['data_Run2018C'] )
samplesDef['data'].add_sample( theTnPSample['data_Run2018D'] )
