...
#############################################################
biningDef = [
   { 'var' : 'sc_eta' , 'type': 'float', 'bins': [-2.5, -2.0, -1.566, -1.444, -1.0, -0.5, 0.0, 0.5, 1.0, 1.444, 1.566, 2.0, 2.5] }, # -- low pT: full eta range (not absolute)
  #  { 'var' : 'sc_abseta' , 'type': 'float', 'bins': [0.0, 0.5, 1.0, 1.444, 1.566, 2.0, 2.5] },
   { 'var' : 'sc_pt' , 'type': 'float', 'bins': [20, 45, 75] }, # -- low pT
...
tnpParNomFit = [
    ...
    "meanF[-0.0,-5.0,5.0]","sigmaF[0.9,0.9,5.0]", # -- bin 06
    ]
